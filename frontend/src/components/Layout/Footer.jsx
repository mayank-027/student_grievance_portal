...
const Footer = () => {
  return (
    <div className="w-full">
      ...
      <footer className="bg-zinc-900 text-zinc-300 py-8 sm:py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
            ...
            <div className="col-span-1 sm:col-span-2">
              ...
              <p className="mb-6 text-zinc-400 max-w-md text-sm sm:text-base">
            ...
            <div className="col-span-1">
              ...
              <ul className="space-y-3 sm:space-y-4">
                <li>
                  ...
                  >
                    <ChevronRight className="h-3 w-3 sm:h-4 sm:w-4 mr-2 flex-shrink-0" />
            ...
            {/* Contact Us section */}
            <div className="col-span-1">
              <h3 className="text-base sm:text-lg font-semibold mb-4 sm:mb-6 text-white mt-4 sm:mt-0">
                Contact Us
              </h3>
              <p className="mb-3 sm:mb-4 text-zinc-400 text-sm sm:text-base">
                Have questions or need assistance?
              </p>
              <a
                href="mailto:support@studentvoice.edu"
                className="text-purple-400 hover:text-purple-300 transition text-sm sm:text-base"
              >
                support@studentvoice.edu
              </a>
              <p className="mt-5 sm:mt-6 mb-3 text-zinc-400 text-sm sm:text-base">
                Download our app:
              </p>
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <button className="bg-zinc-800 text-white text-xs sm:text-sm px-3 sm:px-4 py-2 rounded-full hover:bg-zinc-700 transition flex items-center justify-center sm:justify-start">
                  <svg
